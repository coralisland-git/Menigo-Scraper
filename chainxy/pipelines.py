...
class ChainxyPipeline(object):
    ...
    def __init__(self):
        ...
        self.headers = ['Product_Name', 'Supplier_Name', 'Article_Number', 'Category',
                        'Volumn', 'Alcohol_Percent', 'Country', 'Producer','Package']
                        # ,'Region', 'Year', 'EAN_GTIN', 'Supplier_Article_Number']
